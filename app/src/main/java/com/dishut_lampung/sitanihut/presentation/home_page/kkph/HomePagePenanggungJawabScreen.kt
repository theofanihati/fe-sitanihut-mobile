...
import com.dishut_lampung.sitanihut.presentation.shared.components.card.HomeMenuGrid
import com.dishut_lampung.sitanihut.presentation.shared.components.card.HomeMenuItem
import com.dishut_lampung.sitanihut.presentation.shared.components.card.ReportCard
import com.dishut_lampung.sitanihut.presentation.shared.components.card.ReportSummaryCard
import com.dishut_lampung.sitanihut.presentation.shared.components.card.SummaryRole
...
fun HomePagePenanggungJawabScreen(
    ...
    val penanggungJawabMenus = remember {
        listOf(
            ...
            HomeMenuItem(
                labelTop = "Data",
                labelBottom = "Penyuluh",
                icon = Icons.Outlined.Forest,
                color = tosca,
                onClick = onNavigateToPenyuluh
            ),
            HomeMenuItem(
                labelTop = "Periksa",
                labelBottom = "Laporan",
